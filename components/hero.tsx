    ...
    <section className="relative min-h-screen flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 pt-32 pb-40">
        <div className="max-w-4xl mx-auto text-center">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/80 backdrop-blur-sm border border-border mb-8 shadow-md hover:shadow-lg transition-shadow">
          ...
          {/* Main Title */}
          <h1 className="font-sans text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold text-foreground leading-tight mb-6 text-balance">
            {h.title}
          </h1>
      ...
      <div className="sticky bottom-0 z-20 bg-background/95 backdrop-blur-md border-t border-border py-6">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-card rounded-xl shadow-lg border border-border p-4 lg:p-6 hover:shadow-xl transition-shadow duration-200">
