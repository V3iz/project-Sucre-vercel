...
const hotels: Hotel[] = [
  {
    ...
    description:
      "Hotel boutique de estilo colonial ubicado en el corazón de Sucre, frente a la icónica Plaza 25 de Mayo. Combina la elegancia de la arquitectura patrimonial con comodidades de lujo modernas. Ideal para quienes buscan una experiencia auténtica y sofisticada en la ciudad blanca.",
  ...
  },
  {
    ...
    description:
      "Boutique hotel de 4 estrellas alojado en una mansión del siglo XIX completamente restaurada, declarada Patrimonio Mundial por la UNESCO. Sus terrazas, jardines y habitaciones de época ofrecen una atmósfera de tranquilidad y elegancia única en Sucre.",
  ...
  },
  {
    ...
    description:
      "Hotel de 4 estrellas con historia viva: sus claustros coloniales datan del siglo XVI. Estratégicamente ubicado a metros de la Universidad Mayor de San Francisco Xavier y la Catedral. Sus habitaciones combinan vigas de madera original con baños modernos y tecnología actual.",
  ...
  },
  {
    ...
    description:
      "Hotel de 4 estrellas con una de las mejores relaciones precio-calidad de Sucre. Su ubicación cercana al centro histórico, piscina exterior y desayuno buffet lo convierten en una opción preferida por familias y viajeros que buscan comodidad sin gastar de más.",
  ...
  },
  {
    ...
    description:
      "Con una valoración de 9.3, el Ajayu es el alojamiento boutique económico mejor calificado de Sucre. Situado en el corazón del casco histórico, sus habitaciones están decoradas con textiles jalq'a y artesanías de Chuquisaca, dando una experiencia auténticamente boliviana.",
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
              ...
              <div className="flex flex-wrap gap-3 lg:shrink-0">
                {[
                  { icon: Shield, label: "Hoteles verificados" },
                  { icon: MapPin, label: "Todos en centro histórico" },
                  { icon: Leaf, label: "Opciones sostenibles" },
                ].map(({ icon: Icon, label }) => (
                  <div
                    key={label}
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20">
              <p className="text-muted-foreground text-lg">
                No hay alojamientos con estos filtros.
              </p>
              <button
                onClick={() => {
                  setActiveCategory("todos")
