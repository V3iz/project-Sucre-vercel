...
const restaurants: Restaurant[] = [
  {
    ...
    description:
      "Uno de los restaurantes más representativos de la gastronomía boliviana en Sucre. La Posada captura la esencia de las tradiciones culinarias de Chuquisaca en cada plato, utilizando técnicas ancestrales y productos de la región. Imprescindible para quienes quieren vivir la auténtica experiencia gastronómica local.",
    badge: "Imperdible",
    sustainable: true,
    featured: true,
  ...
  },
  {
    ...
    description:
      "Escondido tras un zaguán colonial, El Huerto sorprende con un frondoso jardín donde se sirven almuerzos y cenas de cocina fresca, ligera y creativa. Es el favorito de los viajeros internacionales por su ambiente tranquilo, su variedad de opciones vegetarianas y sus postres caseros.",
    badge: "Top viajeros",
    sustainable: true,
    featured: true,
  ...
  },
  {
    ...
    description:
      "El Mercado Central es el corazón culinario de Sucre y el mejor lugar para desayunar como lo hacen los locales. Sus decenas de puestos ofrecen desde un reconfortante api morado con pastel hasta un contundente fricasé. Una visita obligatoria para entender la verdadera cultura gastronómica de Chuquisaca.",
  ...
  },
  {
    ...
    specialties: ["Café de altura boliviano", "Singani sour", "Tapas de fusión andina", "Brownie de cacao Beni"],
    highlights: [
    ...
    description:
      "El Condor Café es punto de encuentro de viajeros y creativos locales. Su terraza frente a la Plaza 25 de Mayo es perfecta para desayunar con café de altura boliviano o disfrutar de cócteles de singani al atardecer. Los jueves y viernes hay música en vivo con grupos de folklore y fusión andina.",
    sustainable: false,
    featured: false,
    mustTry: "Singani Sour con cítricos bolivianos",
  },
  {
    id: "sabores-chuquisaqueños",
    ...
    specialties: ["Fritanga chuquisaqueña", "Chorizo chuquisaqueño", "Mondongo", "Ají de cumanda"],
    highlights: [
    ...
    description:
      "Restaurante familiar especializado en los platos más representativos de Chuquisaca. Su fritanga —costillas de cerdo marinadas en chicha y ají colorado— es considerada la mejor de Sucre. El ají amarillo, la papa cocida y el choclo completan una experiencia culinaria que celebra la identidad gastronómica regional.",
  ...
  },
  {
    ...
    specialties: ["Salteñas de pollo", "Salteñas de carne", "Salteñas vegetarianas", "Té de hierbas andinas"],
    highlights: [
    ...
    description:
      "Las salteñas son el desayuno favorito de los sucrenses y esta salteñería las prepara a la perfección: masa dorada, relleno jugoso de carne o pollo con aceitunas, pasas y huevo. Un ritual matutino que no debe saltarse ningún visitante. Solo abren hasta el mediodía o hasta que se acaben.",
    badge: "4.9 / 5",
    sustainable: false,
    featured: false,
...
const priceIcons: Record<"$" | "$$" | "$$$", string> = {
  "$": "Muy económico (< $5)",
  "$$": "Moderado ($5–$15)",
  "$$$": "Premium ($15+)",
}
      ...
      <div className="flex flex-col flex-1 p-5 gap-3">
        ...
        <div className="flex items-center justify-between mt-auto pt-3 border-t border-border">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-0.5">{priceIcons[restaurant.priceRange]}</p>
          </div>
          <Link
            href="/contacto"
          ...
          {restaurant.mustTry && (
            <div className="flex items-center gap-1.5 mt-2">
              ...
              <span className="text-xs text-white/80">
                <span className="font-semibold text-white">Prueba sí o sí:</span> {restaurant.mustTry}
              </span>
            </div>
          )}
        </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6">
              ...
              <div className="flex flex-wrap gap-3 lg:shrink-0">
                {[
                  { icon: ChefHat, label: "Cocina patrimonial" },
                  { icon: Leaf, label: "Ingredientes locales" },
                  { icon: Star, label: "Selección curada" },
                ].map(({ icon: Icon, label }) => (
                  <div
                    key={label}
